...
3.17 Click on Continue button
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        myAccountsPage.clickOnMyAccountLink();
        myAccountsPage.selectMyAccountOptions("Register");
        myAccountsPage.enterFirstName("Jitubhai");
        myAccountsPage.enterLastName("Patel");
        myAccountsPage.enterEmailId("jipa123" + getAlphaNumericString(3) + "@gmail.com");
        myAccountsPage.enterPhoneNumber("1234567890");
        myAccountsPage.enterPassword("jipa123");
        myAccountsPage.enterConfirmPassword("jipa123");
